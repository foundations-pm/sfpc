...
# Save table 
setwd(paste0(output_path, '/1. Main sample/Report descriptive tables'))
writexl::write_xlsx(appendix_tb_1, 'appendix_table_1.xlsx')
...
# Save table 
setwd(paste0(output_path, '/2. Alternative samples/Report descriptive tables'))
writexl::write_xlsx(appendix_tb_1, 'children_with_risk_factors_appendix_table_1.xlsx')
...
# Save table 
setwd(paste0(output_path, '/2. Alternative samples/Report descriptive tables'))
writexl::write_xlsx(appendix_tb_234567, 'children_with_risk_factors_appendix_table_234567.xlsx')
...
# Save table 
setwd(paste0(output_path, '/2. Alternative samples/Report descriptive tables'))
writexl::write_xlsx(appendix_tb_1, 'born_only_children_apprendix_table_1.xlsx')
...
# Save table 
setwd(paste0(output_path, '/2. Alternative samples/Report descriptive tables'))
writexl::write_xlsx(appendix_tb_234567, 'born_only_children_apprendix_table_234567.xlsx')
