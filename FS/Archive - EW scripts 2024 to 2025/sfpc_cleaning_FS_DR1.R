...
lancs_dr1_apr21$Month <- as.Date(format(lancs_dr1_apr21$Month, "%Y-%m-01"))
...
# Recode Telford Nov 21 as FSM is character (includes entry 'TBC')
telford_dr1_nov21$`Proportion of children / young people eligible and claiming for Free School Meals for all school-age children and young people in the LA, out of all pupils.`<-
  as.numeric(telford_dr1_nov21$`Proportion of children / young people eligible and claiming for Free School Meals for all school-age children and young people in the LA, out of all pupils.`)

# Merging Telford ----
all_telford_dr1 <- bind_rows(telford_dr1_nov20, telford_dr1_apr21, telford_dr1_nov21, 
...
walsall_dr1_apr23 <- walsall_dr1_apr23 %>%
  mutate(`Proportion of children / young people eligible and claiming for Free School Meals for all school-age children and young people in the LA, out of all pupils.`=
           `Proportion of children / young people eligible and claiming for Free School Meals for all school-age children and young people in the LA, out of all pupils.` 
         / 100)
...
all_walsall_dr1 <- bind_rows( walsall_dr1_nov20, walsall_dr1_apr21, walsall_dr1_nov21,
                              walsall_dr1_apr22, walsall_dr1_nov22, walsall_dr1_apr23)
