...
rochdale_dr2_nov20 <- read_excel("Data/NWD_DR2/rochdale_dr2_nov20cp.xlsx", 
                                  sheet = "Report 1",
                                  col_types = c("guess","guess","guess","guess","guess","guess","text",
                                                "guess","guess","guess"))
...
rochdale_dr2_nov20 <- rochdale_dr2_nov20[,-c(4)] # removes relevant column
...
redcar_dr2_nov20$Gender <- str_replace(redcar_dr2_nov20$Gender, "[(]", "")
redcar_dr2_nov20$Gender <- str_replace(redcar_dr2_nov20$Gender, "[)]", "")
redcar_dr2_nov20$Gender <- str_replace(redcar_dr2_nov20$Gender, "Not stated/recorded or unborn", "Other/undetermined")
...
colnames(rochdale_dr2_nov20)[3]  <- "Child protection plan start date"
...
all_leic_dr2cp <- rbind(leicester_dr2_nov20, leicester_dr2_apr22)
all_norf_dr2cp <- rbind(norfolk_dr2_nov20, norfolk_dr2_apr22)
all_redcar_dr2cp <- rbind(redcar_dr2_nov20, redcar_dr2_apr22)
all_roch_dr2cp <- rbind.fill(rochdale_dr2_nov20, rochdale_dr2_apr22)
all_warr_dr2cp <- rbind.fill(warrington_dr2_nov20, warrington_dr2_apr22)
...
LA = c("Leicester")
all_leic_dr2cp$LA <- "Leicester"
all_leic_dr2cp <- all_leic_dr2cp %>% relocate(LA)

LA = c("Norfolk")
all_norf_dr2cp$LA <- "Norfolk"
all_norf_dr2cp <- all_norf_dr2cp %>% relocate(LA)

LA = c("Redcar")
all_redcar_dr2cp$LA <- "Redcar"
all_redcar_dr2cp <- all_redcar_dr2cp %>% relocate(LA)

LA = c("Rochdale")
all_roch_dr2cp$LA <- "Rochdale"
all_roch_dr2cp <- all_roch_dr2cp %>% relocate(LA)

LA = c("Warrington")
all_warr_dr2cp$LA <- "Warrington"
all_warr_dr2cp <- all_warr_dr2cp %>% relocate(LA)

# merge all LA dr2 CP data

all_dr2cp <- rbind(all_leic_dr2cp,all_norf_dr2cp,all_redcar_dr2cp,all_roch_dr2cp,all_warr_dr2cp)

# save binded dr2 dataset

save(all_dr2cp, file = "Output/alldr2cp.RData")
