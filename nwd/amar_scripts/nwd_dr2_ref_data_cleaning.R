...
leicester_dr2_nov20 <- read_excel("Data/NWD_DR2/leicester_dr2_nov20.xlsx", 
                                  sheet = "DR2 - Data - sample pop ref",
                                  col_types = c("guess","guess","text","guess","guess","guess", "text",
...
redcar_dr2_nov20 <- read_excel("Data/NWD_DR2/norfolk_dr2_nov20.xlsx", 
                                sheet = "DR2 - Data - sample pop ref",
                                col_types = c("guess","guess","text","guess","guess","guess","text",
                                              "guess","guess","guess","guess","guess"))
...
rochdale_dr2_nov20 <- read_excel("Data/NWD_DR2/rochdale_dr2_nov20ref.xlsx", 
                                sheet = "Sheet2",
                                col_types = c("guess","guess","text","guess","guess","guess","text",
...
leicester_dr2_apr22 <- leicester_dr2_apr22[-c(1,2,3636),] # removes relevant rows
...
rochdale_dr2_nov20 <- rochdale_dr2_nov20[,-c(12,13)] # removes relevant columns

warrington_dr2_nov20 <- warrington_dr2_nov20[-c(1,2), -c(13)] # removes relevant rows
...
redcar_dr2_nov20 <- redcar_dr2_nov20 %>% 
  mutate_all(na_if, "N/A")
stopifnot(sum(redcar_dr2_nov20=="", na.rm=TRUE)==0)
...
leicester_dr2_nov20$Gender <- str_replace(leicester_dr2_nov20$Gender, "[(]", "")
leicester_dr2_nov20$Gender <- str_replace(leicester_dr2_nov20$Gender, "[)]", "")
leicester_dr2_nov20$Gender <- str_replace(leicester_dr2_nov20$Gender, "Not stated/recorded or unborn", "Other/undetermined")
leicester_dr2_apr22$Gender <- str_replace(leicester_dr2_apr22$Gender, "Unborn", "Other/undetermined")
leicester_dr2_apr22$Gender <- str_replace(leicester_dr2_apr22$Gender, "Unknown", "Other/undetermined")
norfolk_dr2_apr22$Gender <- str_replace(norfolk_dr2_apr22$Gender, "Indeterminate", "Other/undetermined")
norfolk_dr2_apr22$Gender <- str_replace(norfolk_dr2_apr22$Gender, "Unborn", "Other/undetermined")
norfolk_dr2_apr22$Gender <- str_replace(norfolk_dr2_apr22$Gender, "Unknown", "Other/undetermined")
norfolk_dr2_nov20$Gender <- str_replace(norfolk_dr2_nov20$Gender, "Indeterminate", "Other/undetermined")
norfolk_dr2_nov20$Gender <- str_replace(norfolk_dr2_nov20$Gender, "Unborn", "Other/undetermined")
redcar_dr2_apr22$Gender <- str_replace(redcar_dr2_apr22$Gender, "Transgender", "Other/undetermined")
redcar_dr2_apr22$Gender <- str_replace(redcar_dr2_apr22$Gender, "[(]", "")
redcar_dr2_apr22$Gender <- str_replace(redcar_dr2_apr22$Gender, "[)]", "")
redcar_dr2_apr22$Gender <- str_replace(redcar_dr2_apr22$Gender, "Not stated/recorded or unborn", "Other/undetermined")
redcar_dr2_nov20$Gender <- str_replace(redcar_dr2_nov20$Gender, "Indeterminate", "Other/undetermined")
redcar_dr2_nov20$Gender <- str_replace(redcar_dr2_nov20$Gender, "Unborn", "Other/undetermined")
rochdale_dr2_apr22$Gender <- str_replace(rochdale_dr2_apr22$Gender, "Indeterminate", "Other/undetermined")
rochdale_dr2_apr22$Gender <- str_replace(rochdale_dr2_apr22$Gender, "Unborn", "Other/undetermined")
rochdale_dr2_nov20$Gender <- str_replace(rochdale_dr2_nov20$Gender, "Indeterminate", "Other/undetermined")
rochdale_dr2_nov20$Gender <- str_replace(rochdale_dr2_nov20$Gender, "Unborn", "Other/undetermined")
warrington_dr2_apr22$Gender <- str_replace(warrington_dr2_apr22$Gender, "Indeterminate", "Other/undetermined")
warrington_dr2_apr22$Gender <- str_replace(warrington_dr2_apr22$Gender, "UnkNwn", "Other/undetermined")
warrington_dr2_nov20$Gender <- str_replace(warrington_dr2_nov20$Gender, "Unknown", "Other/undetermined")

# check for duplicate rows

sum(duplicated(warrington_dr2_nov20))
duplicated(leicester_dr2_apr22)

# duplicated rows omitted

leicester_dr2_apr22 <- leicester_dr2_apr22[-which(duplicated(leicester_dr2_apr22)), ]
leicester_dr2_nov20 <- leicester_dr2_nov20[-which(duplicated(leicester_dr2_nov20)), ]
...
leicester_dr2_apr22$Ethnicity[leicester_dr2_apr22$Ethnicity=="Traveller of Irish Heritage"] <- "WIRT"#
leicester_dr2_apr22$Ethnicity[leicester_dr2_apr22$Ethnicity=="Gypsy / Roma"] <- "WROM"
leicester_dr2_apr22$Ethnicity[leicester_dr2_apr22$Ethnicity=="Chinese"] <- "CHNE"
...
colnames(rochdale_dr2_nov20)[10]  <- "Unaccompanied Asylum Seeker"
colnames(rochdale_dr2_nov20)[7]  <- "Year and month of birth of the child"
colnames(rochdale_dr2_nov20)[5]  <- "Number of previous child protection plans"
colnames(rochdale_dr2_nov20)[11]  <- "Free school meal eligibility - ever FSM"
colnames(rochdale_dr2_nov20)[9]  <- "Disabled status"
colnames(rochdale_dr2_nov20)[4]  <- "Referral no further action"
colnames(rochdale_dr2_nov20)[2]  <- "Referral ID (or Case ID)"

leicester_dr2_nov20$Ethnicity<- str_replace(leicester_dr2_nov20$Ethnicity, "e", "")
leicester_dr2_nov20$Ethnicity<- str_replace(leicester_dr2_nov20$Ethnicity, "b", "")
...
redcar_dr2_nov20$`Disabled status`[redcar_dr2_nov20$`Disabled status`=="Y"] <- "1"
redcar_dr2_nov20$`Disabled status`[redcar_dr2_nov20$`Disabled status`=="N"] <- "0"
...
rochdale_dr2_nov20$`Free school meal eligibility - ever FSM`[rochdale_dr2_nov20$`Free school meal eligibility - ever FSM`=="Yes"] <- "1"
rochdale_dr2_nov20$`Free school meal eligibility - ever FSM`[rochdale_dr2_nov20$`Free school meal eligibility - ever FSM`=="No"] <- "0"

warrington_dr2_nov20$`Free school meal eligibility - ever FSM`[warrington_dr2_nov20$`Free school meal eligibility - ever FSM`=="Yes"] <- "1"
warrington_dr2_nov20$`Free school meal eligibility - ever FSM`[warrington_dr2_nov20$`Free school meal eligibility - ever FSM`=="No"] <- "0"
...
# Assumption made within Rochdale Apr 22 that zeros = No as Yes is referred to as 'True'

rochdale_dr2_apr22$`Free school meal eligibility - ever FSM`[rochdale_dr2_apr22$`Free school meal eligibility - ever FSM`=="True"] <- "1"

# Norfolk referral no further action coded binary - Y = 1 and N = 0

norfolk_dr2_nov20$`Referral no further action`[norfolk_dr2_nov20$`Referral no further action`=="FALSE"] <- "0"
norfolk_dr2_nov20$`Referral no further action`[norfolk_dr2_nov20$`Referral no further action`=="TRUE"] <- "1"
norfolk_dr2_apr22$`Referral no further action`[norfolk_dr2_apr22$`Referral no further action`=="N"] <- "0"
norfolk_dr2_apr22$`Referral no further action`[norfolk_dr2_apr22$`Referral no further action`=="Y"] <- "1"

redcar_dr2_nov20$`Referral no further action`[redcar_dr2_nov20$`Referral no further action`=="FALSE"] <- "0"
redcar_dr2_nov20$`Referral no further action`[redcar_dr2_nov20$`Referral no further action`=="TRUE"] <- "1"
redcar_dr2_apr22$`Referral no further action`[redcar_dr2_apr22$`Referral no further action`=="No"] <- "0"
redcar_dr2_apr22$`Referral no further action`[redcar_dr2_apr22$`Referral no further action`=="Yes"] <- "1"
...
rochdale_dr2_apr22$`Pupil Premium eligibility (for Reception, Year 1 and Year 2)`[rochdale_dr2_apr22$`Pupil Premium eligibility (for Reception, Year 1 and Year 2)`=="FALSE"] <- "0"
...
warrington_dr2_nov20$`Pupil Premium eligibility (for Reception, Year 1 and Year 2)`[warrington_dr2_nov20$`Pupil Premium eligibility (for Reception, Year 1 and Year 2)`=="No"] <- "0"
warrington_dr2_nov20$`Pupil Premium eligibility (for Reception, Year 1 and Year 2)`[warrington_dr2_nov20$`Pupil Premium eligibility (for Reception, Year 1 and Year 2)`=="Yes"] <- "1"
...
leicester_dr2_nov20$`Referral Date` <- as.numeric(leicester_dr2_nov20$`Referral Date`)
leicester_dr2_nov20$`Referral Date` <- as.Date(leicester_dr2_nov20$`Referral Date`, origin = "1899-12-30")
leicester_dr2_apr22$`Referral Date` <- as.numeric(leicester_dr2_apr22$`Referral Date`)
leicester_dr2_apr22$`Referral Date` <- as.Date(leicester_dr2_apr22$`Referral Date`, origin = "1899-12-30")
leicester_dr2_nov20$`Number of previous child protection plans` <- as.numeric(leicester_dr2_nov20$`Number of previous child protection plans`)
...
norfolk_dr2_nov20$`Referral Date` <- as.numeric(norfolk_dr2_nov20$`Referral Date`)
norfolk_dr2_nov20$`Referral Date` <- as.Date(norfolk_dr2_nov20$`Referral Date`, origin = "1899-12-30")
norfolk_dr2_apr22$`Referral Date` <- as.numeric(norfolk_dr2_apr22$`Referral Date`)
norfolk_dr2_apr22$`Referral Date` <- as.Date(norfolk_dr2_apr22$`Referral Date`, origin = "1899-12-30")
...
redcar_dr2_nov20$`Referral Date` <- as.numeric(redcar_dr2_nov20$`Referral Date`)
redcar_dr2_nov20$`Referral Date` <- as.Date(redcar_dr2_nov20$`Referral Date`, origin = "1899-12-30")
redcar_dr2_apr22$`Referral Date` <- as.numeric(redcar_dr2_apr22$`Referral Date`)
redcar_dr2_apr22$`Referral Date` <- as.Date(redcar_dr2_apr22$`Referral Date`, origin = "1899-12-30")
...
#Rochdale - Has issue with initialising columns for 'child protection plan date' & 'year and month of birth of child'.

rochdale_dr2_nov20$`Referral Date` <- as.numeric(rochdale_dr2_nov20$`Referral Date`)
rochdale_dr2_nov20$`Referral Date` <- as.Date(rochdale_dr2_nov20$`Referral Date`, origin = "1899-12-30")
...
rochdale_dr2_nov20$`Free school meal eligibility - ever FSM` <- as.numeric(rochdale_dr2_nov20$`Free school meal eligibility - ever FSM`)

rochdale_dr2_apr22$`Referral Date` <- as.numeric(rochdale_dr2_apr22$`Referral Date`)
rochdale_dr2_apr22$`Referral Date` <- as.Date(rochdale_dr2_apr22$`Referral Date`, origin = "1899-12-30")
...
warrington_dr2_nov20$`Referral Date` <- as.numeric(warrington_dr2_nov20$`Referral Date`)
warrington_dr2_nov20$`Referral Date` <- as.Date(warrington_dr2_nov20$`Referral Date`, origin = "1899-12-30")
warrington_dr2_apr22$`Referral Date` <- as.numeric(warrington_dr2_apr22$`Referral Date`)
warrington_dr2_apr22$`Referral Date` <- as.Date(warrington_dr2_apr22$`Referral Date`, origin = "1899-12-30")
...
warrington_dr2_nov20$`Free school meal eligibility - ever FSM` <- as.numeric(warrington_dr2_nov20$`Free school meal eligibility - ever FSM`)
...
warrington_dr2_nov20$`Pupil Premium eligibility (for Reception, Year 1 and Year 2)` <- as.numeric(warrington_dr2_nov20$`Pupil Premium eligibility (for Reception, Year 1 and Year 2)`)
...
# Created new variable that shows age at referral

leicester_dr2_nov20$Ageatreferral <- as.numeric(difftime(as.Date(leicester_dr2_nov20$`Referral Date`),as.Date(leicester_dr2_nov20$`Year and month of birth of the child`), units = "days")/365.2422)
leicester_dr2_apr22$Ageatreferral <- as.numeric(difftime(as.Date(leicester_dr2_apr22$`Referral Date`),as.Date(leicester_dr2_apr22$`Year and month of birth of the child`), units = "days")/365.2422)
norfolk_dr2_nov20$Ageatreferral <- as.numeric(difftime(as.Date(norfolk_dr2_nov20$`Referral Date`),as.Date(norfolk_dr2_nov20$`Year and month of birth of the child`), units = "days")/365.2422)
norfolk_dr2_apr22$Ageatreferral <- as.numeric(difftime(as.Date(norfolk_dr2_apr22$`Referral Date`),as.Date(norfolk_dr2_apr22$`Year and month of birth of the child`), units = "days")/365.2422)
redcar_dr2_nov20$Ageatreferral <- as.numeric(difftime(as.Date(redcar_dr2_nov20$`Referral Date`),as.Date(redcar_dr2_nov20$`Year and month of birth of the child`), units = "days")/365.2422)
redcar_dr2_apr22$Ageatreferral <- as.numeric(difftime(as.Date(redcar_dr2_apr22$`Referral Date`),as.Date(redcar_dr2_apr22$`Year and month of birth of the child`), units = "days")/365.2422)
rochdale_dr2_apr22$Ageatreferral <- as.numeric(difftime(as.Date(rochdale_dr2_apr22$`Referral Date`),as.Date(rochdale_dr2_apr22$`Year and month of birth of the child`), units = "days")/365.2422)
warrington_dr2_nov20$Ageatreferral <- as.numeric(difftime(as.Date(warrington_dr2_nov20$`Referral Date`),as.Date(warrington_dr2_nov20$`Year and month of birth of the child`), units = "days")/365.2422)
warrington_dr2_apr22$Ageatreferral <- as.numeric(difftime(as.Date(warrington_dr2_apr22$`Referral Date`),as.Date(warrington_dr2_apr22$`Year and month of birth of the child`), units = "days")/365.2422)

# Change column names

colnames(leicester_dr2_nov20)[13]  <- "Age at Referral"
colnames(leicester_dr2_apr22)[13]  <- "Age at Referral"
colnames(norfolk_dr2_nov20)[13]  <- "Age at Referral"
colnames(norfolk_dr2_apr22)[13]  <- "Age at Referral"
colnames(redcar_dr2_nov20)[13]  <- "Age at Referral"
colnames(redcar_dr2_apr22)[13]  <- "Age at Referral"
colnames(rochdale_dr2_apr22)[13]  <- "Age at Referral"
colnames(warrington_dr2_nov20)[13]  <- "Age at Referral"
colnames(warrington_dr2_apr22)[13]  <- "Age at Referral"
colnames(warrington_dr2_apr22)[4]  <- "Referral no further action"

# Move Year and Month of Birth of Child and Age of Referral next to Referral Date

leicester_dr2_nov20 <- leicester_dr2_nov20 %>% relocate(`Year and month of birth of the child`, .after = `Referral Date`)
leicester_dr2_nov20 <- leicester_dr2_nov20 %>% relocate(`Age at Referral`, .after = `Year and month of birth of the child`)
leicester_dr2_apr22 <- leicester_dr2_apr22 %>% relocate(`Year and month of birth of the child`, .after = `Referral Date`)
leicester_dr2_apr22 <- leicester_dr2_apr22 %>% relocate(`Age at Referral`, .after = `Year and month of birth of the child`)
norfolk_dr2_nov20 <- norfolk_dr2_nov20 %>% relocate(`Year and month of birth of the child`, .after = `Referral Date`)
norfolk_dr2_nov20 <- norfolk_dr2_nov20 %>% relocate(`Age at Referral`, .after = `Year and month of birth of the child`)
norfolk_dr2_apr22 <- norfolk_dr2_apr22 %>% relocate(`Year and month of birth of the child`, .after = `Referral Date`)
norfolk_dr2_apr22 <- norfolk_dr2_apr22 %>% relocate(`Age at Referral`, .after = `Year and month of birth of the child`)
redcar_dr2_nov20 <- redcar_dr2_nov20 %>% relocate(`Year and month of birth of the child`, .after = `Referral Date`)
redcar_dr2_nov20 <- redcar_dr2_nov20 %>% relocate(`Age at Referral`, .after = `Year and month of birth of the child`)
redcar_dr2_apr22 <- redcar_dr2_apr22 %>% relocate(`Year and month of birth of the child`, .after = `Referral Date`)
redcar_dr2_apr22 <- redcar_dr2_apr22 %>% relocate(`Age at Referral`, .after = `Year and month of birth of the child`)
rochdale_dr2_apr22 <- rochdale_dr2_apr22 %>% relocate(`Year and month of birth of the child`, .after = `Referral Date`)
rochdale_dr2_apr22 <- rochdale_dr2_apr22 %>% relocate(`Age at Referral`, .after = `Year and month of birth of the child`)
warrington_dr2_nov20 <- warrington_dr2_nov20 %>% relocate(`Year and month of birth of the child`, .after = `Referral Date`)
warrington_dr2_nov20 <- warrington_dr2_nov20 %>% relocate(`Age at Referral`, .after = `Year and month of birth of the child`)
warrington_dr2_apr22 <- warrington_dr2_apr22 %>% relocate(`Year and month of birth of the child`, .after = `Referral Date`)
warrington_dr2_apr22 <- warrington_dr2_apr22 %>% relocate(`Age at Referral`, .after = `Year and month of birth of the child`)


# Merging LA datasets

all_leic_dr2ref <- rbind(leicester_dr2_nov20, leicester_dr2_apr22)
all_norf_dr2ref <- rbind(norfolk_dr2_nov20, norfolk_dr2_apr22)
all_redcar_dr2ref <- rbind(redcar_dr2_nov20, redcar_dr2_apr22)
all_roch_dr2ref <- rbind.fill(rochdale_dr2_nov20, rochdale_dr2_apr22)
all_warr_dr2ref <- rbind(warrington_dr2_nov20, warrington_dr2_apr22)
...
LA = c("Leicester")
all_leic_dr2ref$LA <- "Leicester"
all_leic_dr2ref <- all_leic_dr2ref %>% relocate(LA)

LA = c("Norfolk")
all_norf_dr2ref$LA <- "Norfolk"
all_norf_dr2ref <- all_norf_dr2ref %>% relocate(LA)

LA = c("Redcar")
all_redcar_dr2ref$LA <- "Redcar"
all_redcar_dr2ref <- all_redcar_dr2ref %>% relocate(LA)

LA = c("Rochdale")
all_roch_dr2ref$LA <- "Rochdale"
all_roch_dr2ref <- all_roch_dr2ref %>% relocate(LA)

LA = c("Warrington")
all_warr_dr2ref$LA <- "Warrington"
all_warr_dr2ref <- all_warr_dr2ref %>% relocate(LA)

# merge all LA dr2 ref data

all_dr2ref <- rbind(all_leic_dr2ref,all_norf_dr2ref,all_redcar_dr2ref,all_roch_dr2ref,all_warr_dr2ref)

# save binded dr2 dataset

save(all_dr2ref, file = "Output/alldr2ref.RData")
